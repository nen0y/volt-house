...
async function main() {
  ...
  const deyeEnrichment: Record<string, { img?: string; features: string[] }> = {
    "deye-deye-sun-8k-sg-lp1-1-faza": {
      ...
      features: [
        ...
        "Дисплей: кольоровий сенсорний LCD",
        "Захист: IP65 — для встановлення надворі",
      ],
    },
    "deye-deye-sun-12k-sg05lp3-3-faz": {
      ...
      features: [
        ...
        "Акумулятор: низьковольтний, 48 В",
        "Режими: on-grid / off-grid, підтримка генератора, AC-coupling",
        "Функції: 100% несиметричне навантаження по фазах",
        "Захист: IP65 — для встановлення надворі",
      ],
    },
    "deye-deye-sun-6k-sg-lp1-1-faza": {
      img: "deye-deye-sun-8k-sg-lp1-1-faza.png",
      features: [
        "Модель: SUN-6K-SG05LP1-EU",
        "Тип: гібридний інвертор, 1 фаза",
    ...
    "deye-deye-sun-10k-sg-lp1-1-faza": {
      img: "series-sun-1ph-hybrid-hi.png",
      features: [
        "Модель: SUN-10K-SG02LP1-EU",
        "Тип: гібридний інвертор, 1 фаза",
        "Номінальна потужність: 10 кВт",
        "MPPT: 2 трекери",
        "Акумулятор: низьковольтний, 48 В",
        "Режими: on-grid / off-grid, підтримка генератора, AC-coupling",
        "Дисплей: кольоровий сенсорний LCD",
    ...
    "deye-deye-sun-12k-sg-lp1-1-faza": {
      img: "series-sun-1ph-hybrid-hi.png",
      features: [
        "Модель: SUN-12K-SG02LP1-EU",
        "Тип: гібридний інвертор, 1 фаза",
        "Номінальна потужність: 12 кВт",
        "MPPT: 2 трекери",
        "Акумулятор: низьковольтний, 48 В",
    ...
    "deye-deye-sun-15k-sg05lp3-3-faz": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-15K-SG05LP3-EU-SM2",
        "Тип: гібридний інвертор, 3 фази",
    ...
    "deye-deye-sun-30k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-30K-SG02HP3-EU-BM3",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
        "Номінальна потужність: 30 кВт",
        "Акумулятор: високовольтний (HV)",
        "Режими: on-grid / off-grid, підтримка генератора",
        "Функції: паралельна робота, 100% несиметричне навантаження",
        "Керування: моніторинг через застосунок / Wi-Fi",
        "Захист: IP65 — для встановлення надворі",
      ],
    },
    "deye-deye-sun-50k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-50K-SG01HP3-EU-BM4",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-80k-hp3-v-sokovol-t": {
      img: "series-sun-hp3-big.webp",
      features: [
        "Модель: SUN-80K-SG02HP3-EU-EM6",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-16k-sg-lp1-1-faza": {
      img: "series-sun-1ph-hybrid-hi.png",
      features: [
        "Модель: SUN-16K-SG01LP1-EU",
        "Тип: гібридний інвертор, 1 фаза",
    ...
    "deye-deye-sun-20k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-20K-SG01HP3-EU-BM4",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-20k-sg05lp3-3-faz": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-20K-SG05LP3-EU-SM2",
        "Тип: гібридний інвертор, 3 фази",
        "Номінальна потужність: 20 кВт",
        "MPPT: 2 трекери",
        "Акумулятор: низьковольтний, 48 В",
    ...
    "deye-deye-sun-100-kw-merezhev": {
      img: "series-sun-3ph-string-big.png",
      features: [
        "Модель: SUN-100К-G03",
    ...
    "deye-deye-sun-10k-sg05lp3-3-faz": {
      img: "deye-deye-sun-12k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-10K-SG05LP3-EU",
        "Тип: гібридний інвертор, 3 фази",
        "Номінальна потужність: 10 кВт",
        "MPPT: 2 трекери",
        "Акумулятор: низьковольтний, 48 В",
    ...
    "deye-deye-sun-125k-hp3-v-sokovol-t": {
      img: "series-sun-hp3-big.webp",
      features: [
    ...
    "deye-deye-sun-5k-sg-lp1-1-faza": {
      img: "deye-deye-sun-8k-sg-lp1-1-faza.png",
      features: [
        "Модель: SUN-5KSG03LP1-EU",
        "Тип: гібридний інвертор, 1 фаза",
    ...
    "deye-deye-sun-10-kw-merezhev": {
      img: "series-sun-1ph-string.png",
      features: [
        "Модель: SUN-10K-G04",
        "Тип: мережевий (grid-tie) інвертор, 1 фаза",
        "Номінальна потужність: 10 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 1 фаза, 230 В",
        "Моніторинг: Wi-Fi",
        "Захист: IP65 — для встановлення надворі",
        "Без акумулятора — прямий продаж енергії в мережу",
      ],
    },
    "deye-deye-sun-15-kw-merezhev": {
      img: "deye-deye-sun-30-kw-merezhev.png",
      features: [
        "Модель: SUN-15K-G04",
        "Тип: мережевий (grid-tie) інвертор, 3 фази",
    ...
    "deye-deye-sun-100k-hp3-v-sokovol-t": {
      img: "series-sun-hp3-big.webp",
      features: [
    ...
    "deye-deye-sun-60k-hp3-v-sokovol-t": {
      img: "series-sun-hp3-big.webp",
      features: [
        "Модель: SUN-60K-SG02HP3-EU-EM6",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-25k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-25K-SG01HP3-EU-AM2",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-6-kw-merezhev": {
      img: "series-sun-1ph-string.png",
      features: [
        "Модель: SUN-06K-G (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 1 фаза",
        "Номінальна потужність: 6 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 1 фаза, 230 В",
    ...
    "deye-deye-sun-15k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-15K-SG01HP3-EU",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
        "Номінальна потужність: 15 кВт",
        "Акумулятор: високовольтний (HV)",
        "Режими: on-grid / off-grid, підтримка генератора",
    ...
    "deye-deye-sun-40k-hp3-v-sokovol-t": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-40K-SG01HP3-EU-BM4",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
    ...
    "deye-deye-sun-75k-hp3-v-sokovol-t": {
      img: "series-sun-hp3-big.webp",
      features: [
        "Модель: SUN-75K-SG02HP3-EU-EM6",
        "Тип: гібридний інвертор, 3 фази (високовольтна батарея)",
        "Номінальна потужність: 75 кВт",
        "Акумулятор: високовольтний (HV)",
        "Режими: on-grid / off-grid, підтримка генератора",
        "Функції: паралельна робота, 100% несиметричне навантаження",
        "Керування: моніторинг через застосунок / Wi-Fi",
    ...
    "deye-k-ta-deye-sun-20-sg05lp3-eu-sm2-nov-nk": {
      img: "deye-deye-sun-16k-sg05lp3-3-faz.png",
      features: [
        "Модель: SUN-20-SG05LP3-EU-SM2",
        "Тип: гібридний інвертор, 3 фази",
        "Номінальна потужність: 20 кВт",
        "MPPT: 2 трекери",
        "Акумулятор: низьковольтний, 48 В",
    ...
    "deye-deye-sun-125-kw-merezhev": {
      img: "series-sun-3ph-string-big.png",
      features: [
        "Модель: SUN-125K-G (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 3 фази",
        "Номінальна потужність: 125 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 3 фази, 380/400 В",
    ...
    "deye-deye-sun-12-kw-merezhev": {
      img: "series-sun-1ph-string.png",
      features: [
        "Модель: SUN-12K-G06 (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 1 фаза",
        "Номінальна потужність: 12 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 1 фаза, 230 В",
    ...
    "deye-deye-sun-135-kw-merezhev": {
      img: "series-sun-3ph-string-big.png",
      features: [
        "Модель: SUN-135K-G (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 3 фази",
        "Номінальна потужність: 135 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 3 фази, 380/400 В",
        "Моніторинг: Wi-Fi",
        "Захист: IP65 — для встановлення надворі",
    ...
    "deye-deye-sun-25-kw-merezhev": {
      img: "deye-deye-sun-30-kw-merezhev.png",
      features: [
        "Модель: SUN-25K-G04 (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 3 фази",
        "Номінальна потужність: 25 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 3 фази, 380/400 В",
    ...
    "deye-deye-sun-80-kw-merezhev": {
      img: "series-sun-3ph-string-big.png",
      features: [
        "Модель: SUN-80K-G (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 3 фази",
        "Номінальна потужність: 80 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 3 фази, 380/400 В",
    ...
    "deye-deye-sun-8-kw-merezhev": {
      img: "series-sun-1ph-string.png",
      features: [
        "Модель: SUN-08K-G (Wi-Fi)",
        "Тип: мережевий (grid-tie) інвертор, 1 фаза",
        "Номінальна потужність: 8 кВт",
        "Макс. ККД: понад 98%",
        "Підключення: 1 фаза, 230 В",
    ...
    "deye-deye-bos-g-5-1": {
      img: "series-bos-g-pro.jpg",
      features: [
        "Модель: BOS-G Pro 5,12kWh",
        "Тип: акумулятор LiFePO₄, низьковольтний (модуль для стійки)",
        "Номінальна напруга: 51,2 В",
        "Ємність: 5,12 кВт·год (100 Ач)",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
        "Масштабування: об'єднання кількох модулів у стійці",
      ],
    },
    "deye-deye-se-f5-pro-c": {
      img: "series-se-f5.jpg",
      features: [
        "Модель: SE-F5 Pro-C",
        "Тип: акумулятор LiFePO₄, низьковольтний, настінний",
        "Ємність: 5,12 кВт·год",
        "Номінальна напруга: 51,2 В",
        "Дисплей: круглий індикатор заряду",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
      ],
    },
    ...
    "deye-deye-rack-h": {
      features: [
        "Модель: 3U-HRACK",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
      ],
    },
    "deye-deye-se-f12": {
      img: "series-se-f16.jpg",
      features: [
        "Модель: SE-F12 C",
        "Тип: акумулятор LiFePO₄, низьковольтний (вежа)",
        "Ємність: ~12,3 кВт·год",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
      ],
    },
    ...
    "deye-deye-bos-g-pdu2": {
      img: "series-hv-control-box.png",
      features: [
        "Модель: BOS-G-PDU-2",
        "Тип: керуючий модуль (BMS / PDU) для батарейної збірки Deye",
        "Призначення: керування, комутація та захист батарейних модулів",
        "Сумісність: акумуляторні стійки Deye BOS-G / BOS-A / BOS-B",
      ],
    },
    "deye-deye-rack-l": {
      features: [
        "Модель: BOS-G-3U-LRACK",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
      ],
    },
    "deye-deye-bos-b-pack16": {
      img: "series-bos-b.jpg",
      features: [
        "Модель: HV BOS-B-Pack16-A3-Pro",
        "Тип: високовольтний акумулятор LiFePO₄ (C&I)",
        "Застосування: комерційні та промислові системи накопичення",
        "Комунікація: BMS, RS485 / CAN",
        "Масштабування: модульна збірка у стійці",
      ],
    },
    "deye-deye-se-f5-pro-l": {
      img: "series-se-f5.jpg",
      features: [
        "Модель: SE-F5 Pro-L",
        "Тип: акумулятор LiFePO₄, низьковольтний, настінний",
    ...
    "deye-deye-rw-m6-1-b": {
      img: "series-rw-m6-1.jpg",
      features: [
        "Модель: RW-M6.1-B",
        "Тип: акумулятор LiFePO₄, низьковольтний, настінний",
        "Ємність: 6,14 кВт·год",
        "Номінальна напруга: 51,2 В",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
      ],
    },
    "deye-deye-ess-ge-f60-60-kw-h": {
      img: "series-ess-ge-f60.jpg",
      features: [
        "Модель: ESS GE-F60",
        "Тип: акумулятор LiFePO₄ Deye",
        "Комунікація: вбудована BMS, RS485 / CAN",
      ],
    },
    "deye-akumulyator-deye-lfp-102-4v-40a-gb-lm4-0": {
      img: "series-gb-l.jpg",
      features: [
        "Модель: GB-LM4.0",
        "Тип: високовольтний акумуляторний модуль LiFePO₄",
        "Номінальна напруга: 102,4 В",
        "Комунікація: вбудована BMS",
      ],
    },
    "deye-bos-a-rack-11-deye": {
      img: "series-bos-a.jpg",
      features: [
        "Модель: BOS-A-RACK-11",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
      ],
    },
    "deye-bos-a-rack14-deye-14-sht": {
      img: "series-bos-a.jpg",
      features: [
        "Модель: BOS-A-Rack14",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
        "Місткість: до 14 модулів",
      ],
    },
    "deye-bms-kontroler-bos-g-pro-pdu-2-deye-sh": {
      img: "series-hv-control-box.png",
      features: [
        "Модель: BOS-G-Pro-PDU-2",
        "Тип: керуючий модуль (BMS / PDU) для батарейної збірки Deye",
        "Призначення: керування, комутація та захист батарейних модулів",
        "Сумісність: акумуляторні стійки Deye BOS-G / BOS-A / BOS-B",
      ],
    },
    "deye-sti-ka-dlya-13-batare-deye-bos-g": {
      img: "series-bos-g-pro.jpg",
      features: [
        "Модель: Стійка DEYE BOS-G 13 шт.",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
        "Місткість: до 13 модулів",
      ],
    },
    "deye-sti-ka-dlya-8-1-batare-deye-bos-g": {
      img: "series-bos-g-pro.jpg",
      features: [
        "Модель: Стійка DEYE BOS-G 8+1 шт.",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
        "Місткість: до 8+1 модулів",
      ],
    },
    "deye-bms-kontroler-deye-bos-g-120-750-vdc-100": {
      img: "series-hv-control-box.png",
      features: [
        "Модель: HVB750V100A",
        "Тип: керуючий модуль (BMS / PDU) для батарейної збірки Deye",
    ...
    "deye-bos-a-pack7-68-deye-high-voltage-lifepo": {
      img: "series-bos-a.jpg",
      features: [
        "Модель: BOS-A-Pack7.68",
        "Тип: високовольтний акумулятор LiFePO₄ (C&I)",
        "Застосування: комерційні та промислові системи накопичення",
        "Комунікація: BMS, RS485 / CAN",
        "Масштабування: модульна збірка у стійці",
    ...
    "deye-bms-kontroler-bos-b-pdu-2-a-deye-sht": {
      img: "series-hv-control-box.png",
      features: [
        "Модель: BOS-B-PDU-2-A",
        "Тип: керуючий модуль (BMS / PDU) для батарейної збірки Deye",
        "Призначення: керування, комутація та захист батарейних модулів",
        "Сумісність: акумуляторні стійки Deye BOS-G / BOS-A / BOS-B",
      ],
    },
    "deye-deye-bos-a-lifepo4-hv-38-4v-200ah": {
      img: "series-bos-a.jpg",
      features: [
        "Модель: BOS-A LiFePO4 HV 38.4V 200AH",
        "Тип: високовольтний акумулятор LiFePO₄ (C&I)",
        "Застосування: комерційні та промислові системи накопичення",
        "Комунікація: BMS, RS485 / CAN",
        "Масштабування: модульна збірка у стійці",
    ...
    "deye-deye-bos-b-pro-a3": {
      img: "series-bos-b-pro-a3.jpg",
      features: [
        "Модель: BOS-B PRO A3",
        "Тип: високовольтний акумулятор LiFePO₄ (C&I)",
        "Застосування: комерційні та промислові системи накопичення",
    ...
    "deye-komplekt-deye-bos-b-pro-sti-ka-bms-a": {
      img: "series-bos-b.jpg",
      features: [
        "Модель: BOS-B PRO Kit",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
        "Призначення: розміщення та комутація батарейних модулів у стійці",
      ],
    },
    "deye-komplekt-deye-bos-b-sti-ka-bms-akb-l": {
      img: "series-bos-b.jpg",
      features: [
        "Модель: BOS-B Kit LV",
        "Тип: монтажна стійка для акумуляторних модулів Deye",
    ...
    "deye-deye-se-g5-3": {
      ...
      features: [
        ...
        "Тип: акумулятор LiFePO₄, низьковольтний (модуль для стійки)",
        "Номінальна напруга: 51,2 В",
        "Ємність: 5,32 кВт·год (104 Ач)",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
        "Масштабування: об'єднання кількох модулів у стійці",
      ],
    },
    "deye-akumulyator-lifepo4-deye-se-g5-3-51-2v-1": {
      img: "deye-deye-se-g5-1-pro-b.jpg",
      features: [
        "Модель: SE-G5.3",
        "Тип: акумулятор LiFePO₄, низьковольтний (модуль для стійки)",
    ...
    "deye-akumulyatorna-batareya-deye-al-w10-2kwh-lv": {
      img: "series-al-w.jpg",
      features: [
        "Модель: AL-W10.2kWh LV",
        "Тип: акумулятор LiFePO₄, низьковольтний, стековий",
        "Ємність: 10,24 кВт·год",
        "Ресурс: понад 6000 циклів",
        "Комунікація: RS485 / CAN, вбудована BMS",
      ],
    },
    "deye-akumulyator-deye-lfp-100a-51-2v-se-g5-1": {
      img: "deye-deye-se-g5-1-pro-b.jpg",
      features: [
        "Модель: SE-G5.1 Pro",
        "Тип: акумулятор LiFePO₄, низьковольтний (модуль для стійки)",
    ...
    "deye-deye-sun-125k-pcs": {
      img: "series-sun-hp3-big.webp",
      features: [
        "Модель: SUN-125K-PCS01HP3",
        "Тип: перетворювач потужності (PCS) для систем накопичення",
        "Потужність: 125 кВт",
        "Призначення: заряд/розряд промислових акумуляторних систем",
      ],
    },
    "deye-modul-mppt-sun-mppt-l01-eu-am8-deye": {
      img: "series-mppt-l01.jpg",
      features: [
        "Модель: SUN-MPPT-L01-EU-AM8",
        "Тип: MPPT-модуль (сонячний контролер заряду) Deye",
        "Призначення: підключення фотомодулів до системи Deye",
      ],
    },
    "deye-aio-modul-bmu-osnova-gb-lb-lbase-deye": {
      img: "series-gb-lb.jpg",
      features: [
        "Модель: GB-LB+Lbase",
        "Тип: модуль BMU + основа для батарейної збірки Deye",
        "Призначення: керування та монтаж акумуляторних модулів",
      ],
    },
    "deye-ai-w5-1-12k-sg04lpp3-eu-deye-ess-12-kw": {
      img: "series-ai-w51.jpg",
      features: [
        "Модель: AI-W5.1-12K-SG04LPP3-EU",
        "Тип: система «все-в-одному» (гібридний інвертор + акумулятор)",
        "Потужність інвертора: 12 кВт",
        "Акумулятор: LiFePO₄, масштабований (до 30 кВт·год)",
        "Режими: on-grid / off-grid",
        "Монтаж: підлоговий, стековий — без зайвої проводки",
        "Керування: застосунок / ПК / сенсорний дисплей",
      ],
    },
    "deye-ai-w5-1-8k-sg01lp1-eu-deye-ess-8-kw-1": {
      img: "series-ai-w51.jpg",
      features: [
        "Модель: AI-W5.1-8K-SG01LP1-EU",
        "Тип: система «все-в-одному» (гібридний інвертор + акумулятор)",
    ...
    "deye-s-stema-nakop-chennya-deye-bess-bos-b-240": {
      img: "series-bos-b.jpg",
      features: [
        "Модель: BESS BOS-B 240",
        "Тип: промислова система накопичення енергії (BESS)",
        "Потужність: 240 кВт",
        "Акумулятори: LiFePO₄, високовольтні",
        "Призначення: комерційні та промислові об'єкти",
      ],
    },
  };
  ...
  for (const p of deyeProducts) {
    ...
    if (ENRICH && enrich) {
      ...
      // Some accessories (controllers, PDU/BMS modules) have no official photo —
      // those keep whatever image they already have; only the description updates.
      const url = enrich.img ? copySeedImage(enrich.img) : null;
      if (url) {
