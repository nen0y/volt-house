...
function CatalogButton({ href, label }: { href: string; label: string }) {
  return (
    <div className="flex justify-center mt-[24px]">
      <Link
        href={href}
        className="inline-flex items-center gap-[8px] bg-blue-600 text-white text-[14px] font-semibold rounded-full px-[28px] py-[12px] hover:bg-blue-700 transition-colors"
      >
        {label}
  ...
  return (
    <>
      ...
      {list.map((s) => {
        ...
        if (s.mode === "cta") {
          return (
            <section key={s.id} className="bg-blue-600 py-[44px]">
              <div className="max-w-[1280px] mx-auto px-[24px] text-center">
                ...
                {s.subtitle && (
                  <p className="text-[14px] text-blue-100 mb-[24px] max-w-[600px] mx-auto leading-relaxed">
                    {s.subtitle}
                  </p>
                )}
                <div className="flex items-center justify-center gap-[12px] flex-wrap">
                  <button
                    ...
                    className="bg-white text-blue-700 text-[14px] font-semibold rounded-full px-[28px] py-[12px] hover:bg-blue-50 transition-colors cursor-pointer"
                  >
