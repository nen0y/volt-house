        ...
        >
          <div className="max-w-[1280px] mx-auto px-[24px] h-[64px] flex items-center justify-between gap-[32px]">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-[6px] shrink-0 bg-blue-600 hover:bg-blue-700 text-white text-[13px] font-semibold px-[16px] py-[8px] rounded-full transition-colors cursor-pointer whitespace-nowrap"
            >
